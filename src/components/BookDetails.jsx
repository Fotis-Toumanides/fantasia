    ...
    return(
        ...
        {bookDetails.map((bookDetail) => (
            <li key={bookDetail.id} className='p-4'>
                    ...
                    <img src={`https://fotistouman.pythonanywhere.com/covers/${bookDetail.cover}`} alt={bookDetail.title} className='w-full h-auto hover:shadow-2xl' onClick={()=> handleReadBook(bookDetail.id)}/>
